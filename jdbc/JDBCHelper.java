...
public class JDBCHelper {
    ...
    public ResultSet listDentists(Connection conn){
    ...
    public ResultSet addPatient(Connection conn, String insurance, String email, String record_id, String user_id){
    ...
    public ResultSet checkAppointment(Connection conn){
    ...
    //
    public ResultSet setAppointment(Connection conn, String appointment_id, String a_date, String start_time, String end_time, String appointment_type, String status, int fee_id, int treatment_code){
    ...
    public ResultSet addEmployee(Connection conn, String employeerole, String employeetype, int salary, int user_id, int branch_id){
    ...
    public ResultSet checkProcedures(Connection conn){
    ...
    public static void main(String[] args){
        ...
        try (Connection conn = DriverManager.getConnection(
                "jdbc:postgres://srsqrkamklhsii:f01068b4fd889f7cd0d23b191f5eeb9729674ee40dce0a5b7063342aacd94a47@ec2-18-215-96-22.compute-1.amazonaws.com:5432/daek7g9mrllna4", 
                "srsqrkamklhsii", 
